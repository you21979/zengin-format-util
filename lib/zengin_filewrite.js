...
var receivedPaymentDetail = exports.receivedPaymentDetail = function(file, data){
    var size = getSizeOfSpec(Spec.FORMAT_DEPOSIT_DETAIL, data);
...
var bulkTransfer = exports.bulkTransfer = function(file, data){
    var size = getSizeOfSpec(Spec.FORMAT_BULK_TRANSFER, data);
    var bw = zenginSerializer(convertSJIS(data), size)
    return writeFile(file, bw.buff)
}
