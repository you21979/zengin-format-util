...
var receivedPaymentDetailFromBuff = exports.receivedPaymentDetailFromBuff = function(buff){
    var result = zenginParser(buff, Spec.FORMAT_RECEIVED_PAYMENTS_DETAIL);
    return convertUTF8(result);
}

var depositsAndWithdrawalsDetailFromBuff = exports.depositsAndWithdrawalsDetailFromBuff = function(buff){
    var result = zenginParser(buff, Spec.FORMAT_DEPOSITS_AND_WITHDRAWALS_DETAIL)
    return convertUTF8(result);
}
